...
class Worker(object):
    """
    An A3C worker thread. Runs episodes locally and updates global shared value
    and policy nets.
    ...
    Args:
        ...
        max_global_steps: If set, stop coordinator when
            global_counter > max_global_steps
    """
    def __init__(
        self,
        name,
        ...
        with sess.as_default(), sess.graph.as_default():
            ...
            try:
                while not coord.should_stop():
                    ...
                    if (self.max_global_steps is not None and
                            global_t >= self.max_global_steps):
    ...
    def run_n_steps(self, n, sess):
        ...
        for _ in range(n):
            ...
            self.env.step(self.env.actions[selected_action])
